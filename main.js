...
const urlsToCache = [
  ...
  "/main.js",
  "/icons/icon-512.png",
  "/icons/maskable_icon_x512 (1).png",
  "/icons/icon-1024.png",
...
const tickingSound = new Audio("/sound/ticking-clock_1-27477.mp3");
const alarmAudio = new Audio("/sound/Alarm-Fast-A1-www.fesliyanstudios.com.mp3");
